    ...
    const handleSendMessage = async (e) => {
        ...
        if (selectedImage) {
            ...
            reader.onload = async () => {
                ...
                await sendMessage({ text: input, image: base64Image });
                setInput("");
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      <div className="flex items-center gap-3 py-3 mx-4 border-b border-stone-500">
        <img src={selectedUser?.pic || assets.avatar_icon} alt="" className="w-8 rounded-full" />
        ...
        <img
          ...
          alt=""
          className="med:hidden max-w-7 cursor-pointer"
        />
        <img
          ...
          >
            {msg.image ? (
              <img
                src={msg.image}
                alt=""
                className="max-w-[230px] border border-grey-700 rounded-lg overflow-hidden mb-8 cursor-pointer"
            ...
            <div className="text-center text-xs">
              <img
                src={msg.senderId === authUser._id ? (authUser.pic || assets.avatar_icon) : (selectedUser.pic || assets.avatar_icon)}
                alt=""
